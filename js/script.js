document.addEventListener('DOMContentLoaded', function() {
    ...
    if (mobileMenuToggle) {
        ...
        mobileMenuToggle.addEventListener('click', function() {
            ...
            body.classList.toggle('menu-open'); // Блокируем прокрутку body при открытом меню
        });
    ...
    function calculatePrice() {
        ...
        additionalServices.forEach(service => {
            ...
            if (additionalServicesPrices[serviceName]) {
                price += additionalServicesPrices[serviceName] * days;
            }
        });
